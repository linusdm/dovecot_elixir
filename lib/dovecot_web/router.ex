defmodule DovecotWeb.Router do
  use DovecotWeb, :router

  import DovecotWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {DovecotWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: DovecotWeb.Telemetry
    end
  end
  ...
  live_session :default, on_mount: DovecotWeb.UserLiveAuth do
    scope "/", DovecotWeb do
      pipe_through [:browser, :require_authenticated_user]
